...
const URLContent = ({ data }: URLContentProps) => {
  ...
  return (
    <div className="text-center py-8">
      ...
      {data.description && (
        <p className="text-lg text-pink-primary/80 my-4 italic mb-8">
          {data.description}
        </p>
      )}
      ...
      <Button
        onClick={handleClick}
        size="lg"
        className="group relative inline-flex items-center gap-3 text-lg font-bold bg-gradient-to-br from-pink-light via-pink-primary to-gold hover:scale-110 active:scale-95 overflow-hidden shadow-lg shadow-gold/30 hover:shadow-xl hover:shadow-gold/50"
      >
        {/* Shimmer effect */}
        <div 
